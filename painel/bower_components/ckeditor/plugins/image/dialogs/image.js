		...
		return {
			...
			contents: [{
				...
				},
				{
					...
					"default": "",
					items: [[d.lang.common.notSet, ""], [d.lang.common.alignLeft, "left"], [d.lang.common.alignCenter, "middle"], [d.lang.common.alignRight, "right"]],
					onChange: function() {
						e(this.getDialog());
						k.call(this, "advanced:txtdlgGenStyle")
					},
					...
					commit: function(a, b) {
						...
						if (1 == a || 4 == a) {
							if (c == "middle") {
								if (c ? b.setStyle("vertical-align", c) : b.removeStyle("vertical-align"), 1 == a)
